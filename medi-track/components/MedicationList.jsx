...
export default function MedicationList() {
  ...
  return (
    <View style={{
      ...
      <Image source={require('./../assets/images/medication.png')} 
      style={{
        width: "100%",
        height: 200,
        borderRadius: 15
      ...
      renderItem={({item, index}) => (
          <TouchableOpacity style={[styles.dateGroup,{backgroundColor:item.formatedDate==selectedDate?Colors.PRIMARY : Colors.LIGHT_GRAY}]}
